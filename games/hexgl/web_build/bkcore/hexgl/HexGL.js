...
bkcore.hexgl.HexGL.prototype.displayScore = function(f, l)
{
	...
	var shareUrl = window.location != undefined ? window.location.href : '.';
	var shareImg;
	try {
		shareImg = new URL('icon_256.png', shareUrl).toString();
	} catch(e) {
		shareImg = 'icon_256.png';
	}
	var shareText = 'I just scored '+dt.innerHTML+' in '+'Cityscape ('+d+') on #HexGL!';
	st != undefined && (st.href='https://twitter.com/share?text='+encodeURIComponent(shareText)+'&url='+encodeURIComponent(shareUrl));
	sf != undefined && (sf.href='https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(shareUrl)
		+'&quote='+encodeURIComponent(shareText)
		+'&picture='+encodeURIComponent(shareImg));
